...
import AddtoCart from './scenes/Cart/Cart';
import { CartProvider } from "./scenes/Cart/ContextCart"
...
let winterProductsSet1 = products.winterProductsSet1;
let Occasionwear = products.Occasionwear;
let Sportswear = products.Sportswear;
let Footwear = products.Footwear;
let Accessories = products.Accessories;
        ...
        <BrowserRouter>
          ...
          <Routes>
            ...
            <Route
              ...
              element={<ProductDetails products={{ winterProductsSet1, Occasionwear, Sportswear, Footwear, Accessories }} addToCart={addToCart} />}
            />
            <Route path="/Cart"
              element={<AddtoCart />}
            />
